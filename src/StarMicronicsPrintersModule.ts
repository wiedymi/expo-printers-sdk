...
import type { StarMicronicsPrintersModuleEvents, StarMicronicsPrinterInfo } from "./StarMicronicsPrinters.types";
...
export default requireNativeModule<StarMicronicsPrintersModule>("StarMicronicsPrintersModule"); 